...
public class AltaMecanicoGUI extends JFrame {
	...
	public AltaMecanicoGUI() {
		setTitle("Dar alta mecanico");
		setDefaultCloseOperation(JFrame.DISPOSE_ON_CLOSE);
		setBounds(100, 100, 500, 400);
		generarAltaMecanicoGUI();
	}
	public void generarAltaMecanicoGUI() {
		...
		JLabel lblNewLabel = new JLabel("Complete los campos para dar de alta un mecanico:");
				...
				if (hayvacios) {
					...
					try {
						...
						if (validarDatosMec) {
							...
							mecDTO.setApellido(textFieldApellido.getText().toString());
							mecDTO.setNombre(textFieldNombre.getText().toString());
